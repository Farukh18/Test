...
class Practicum {
    ...
    private static void addUser() {
        ...
        } catch (ValidateNameException bebra) {
            System.out.println("Ошибка валидации имени " + bebra.getMessage());
        } catch (ValidatePasswordException exp){
            System.out.println("Ошибка валидации пароля " + exp.getMessage());
