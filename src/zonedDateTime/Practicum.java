...
class Practicum {
    ...
    private static void printFlightInformation(
        ...
        //...
        try{departureAirport = AirportDatabase.getAirportByCode(departureAirportCode);
        ...
        ZoneId zone = ZoneId.of(departureAirport.getZone());
        ZonedDateTime departure =  ZonedDateTime.of(dateTime, zone);
        ...
        ZoneId zone2 = ZoneId.of(arrivalAirport.getZone());
        //ZonedDateTime arrival = ZonedDateTime.of(dateTime, zone2);
        ZonedDateTime arrival =  departure.plus(flightDuration).withZoneSameInstant(zone2);
        ...
        if (delay > 0) {
            ...
            System.out.println(String.format(String.format("Задержка: " + delayDuration.toHours()+ ":" + delayDuration.toMinutes())));
